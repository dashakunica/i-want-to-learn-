...
{
    new public string GetCode() { return this.GetCurrentCode(); }
...
internal class DerivedClassB : DerivedClassA
{
    ...
    new public string GetCode() { return DerivedClassImpl.GetCode(); }
...
public class Program
{
    ...
    {
        // Debug changed at Trace due the ?unknown? error
        // P.s with Trace everything works fine
